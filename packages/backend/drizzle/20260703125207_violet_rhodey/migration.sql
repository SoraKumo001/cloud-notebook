...
INSERT INTO `__new_user_settings`(`user_id`, `ai_provider`, `ai_api_key`, `ai_base_url`, `ai_embedding_model`, `model_chat`, `model_summarization`, `model_ocr`, `created_at`, `updated_at`) SELECT `user_id`, `ai_provider`, `ai_api_key`, `ai_base_url`, `ai_embedding_model`, `model_chat`, `model_summarization`, `model_ocr`, `created_at`, `updated_at` FROM `user_settings`;--> statement-breakpoint
