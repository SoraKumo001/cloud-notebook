...
const SORT_OPTIONS: SortOption[] = [
  { label: 'Last updated', field: 'updated_at', order: 'desc' },
    ...
    <div className='min-h-screen bg-base-200 text-base-content flex flex-col font-sans'>
      ...
      <main className='flex-1 max-w-7xl w-full mx-auto px-6 py-10'>
        <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8'>
          <div>
            <h1 className='text-3xl font-bold tracking-tight text-base-content'>Notebooks</h1>
            <p className='mt-1 text-base-content/60'>Organize your research and sources.</p>
          </div>
        ...
        {loading ? (
          ...
          <div className='rounded-2xl border border-dashed border-base-300 bg-base-100/30 p-12 text-center'>
            ...
            <h2 className='text-xl font-semibold text-base-content/90 mb-2'>
              {debouncedQuery ? 'No notebooks match your search' : 'No notebooks yet'}
            </h2>
            <p className='text-base-content/60 max-w-md mx-auto mb-6'>
              {debouncedQuery
                ? `No results for "${debouncedQuery}". Try a different keyword.`
                : 'Create your first notebook to start collecting sources, notes, and research.'}
            </p>
            {debouncedQuery ? (
