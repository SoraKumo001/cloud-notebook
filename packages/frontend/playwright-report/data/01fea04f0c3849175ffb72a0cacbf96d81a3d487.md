...
- Name: notebook-flow.spec.ts >> Notebook detail page >> upload dropzone is visible on the page
- Location: e2e\notebook-flow.spec.ts:89:3
...
Locator: locator('text=Upload sources')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Upload sources')
