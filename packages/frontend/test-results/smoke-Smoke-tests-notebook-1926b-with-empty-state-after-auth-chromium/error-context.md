...
- Name: smoke.spec.ts >> Smoke tests >> notebooks page loads with empty state after auth
- Location: e2e\smoke.spec.ts:57:3
...
Locator: locator('text=No notebooks yet')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=No notebooks yet')
...
- banner:
  - link "N Cloud open-notebook":
    - /url: /
  - text: Dev User
  - button "Global settings"
  - button "Sign Out"
- main:
  - heading "Notebooks" [level=1]
  - paragraph: Organize your research and sources.
  - button "New Notebook"
  - textbox "Search notebooks..."
  - combobox:
    - option "Last updated" [selected]
    - option "Newest first"
    - option "Title A-Z"
    - option "Title Z-A"
  - 'link "{count, plural, one {# source} other {# sources}} TestNote No description Updated {date}"':
    - /url: /notebooks/4fea3810-61da-432b-af14-e21a1a5b22b6
    - text: "{count, plural, one {# source} other {# sources}}"
    - heading "TestNote" [level=3]
